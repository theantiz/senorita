...
from app.db.models import User, Contact, Task, MemoryEntry
...
async def main():
    async with async_session_factory() as session:
        ...
        await run_test("Case 1: Known contact + clear date",
            "I'll follow up with Rahul about the proposal on Friday",
            "Got it. I've noted that down.")
            
        # Test 2: Ambiguous/Unknown contact
        await run_test("Case 2: Unknown contact",
            "Remind me to send the files to Bartholomew tomorrow",
            "I'll remember that.")
            
        # Test 3: Vague statement with no clear date
        await run_test("Case 3: Vague statement",
            "I should reach out to her sometime",
