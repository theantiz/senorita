...
class Integration(Base):
    ...
    status: Mapped[str] = mapped_column(Text, server_default="disconnected", nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            status.in_(["connected", "disconnected", "error", "token_expired"]), name="chk_integrations_status"
        ),
    )
