...
class AgentRun(Base):
    ...
    events = relationship(
        "AgentEvent", back_populates="run", cascade="all, delete-orphan", order_by="AgentEvent.sequence_number"
    )
...
class AgentEvent(Base):
    ...
    __table_args__ = (Index("ix_agent_events_run_id_seq", "run_id", "sequence_number", unique=True),)
