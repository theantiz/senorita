...
from app.services.reminder_service import create_reminder, delete_reminder, get_reminder, get_reminders, update_reminder
...
async def read_reminder(
    reminder_id: UUID, session: AsyncSession = Depends(get_db), current_user: User = Depends(get_current_user)
):
...
async def create_new_reminder(
    reminder_in: ReminderCreate, session: AsyncSession = Depends(get_db), current_user: User = Depends(get_current_user)
):
