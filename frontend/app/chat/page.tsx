    ...
    <div className="flex flex-col h-[calc(100vh-7rem)]">
      ...
      <div className="grid shrink-0 grid-cols-2 gap-3 sm:flex">
        ...
        <button
          ...
          className="px-5 py-3 font-hud text-[9px] tracking-[0.2em] text-background bg-surface border border-border text-foreground shadow-[0_0_15px_var(--glow)] hover:bg-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors shrink-0"
          style={{ clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))' }}
        >
          SEND
        </button>
