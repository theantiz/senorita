              ...
              {activeTab === "login" ? (
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-surface border border-border text-foreground shadow-[0_0_15px_var(--glow)] text-black font-display font-medium text-sm px-4 py-3 hover:bg-white/90 transition-colors tracking-wide disabled:opacity-50"
                  >
