            ...
            <ul className="space-y-2">
              {openTasks.slice(0, 6).map((t) => (
                <li key={t.id} className="flex items-center gap-2.5 group">
                  <div className="w-1 h-1 bg-white/40 rotate-45 shrink-0 group-hover:bg-surface border border-border text-foreground shadow-[0_0_15px_var(--glow)] transition-colors" />
